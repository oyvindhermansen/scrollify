...
var Scrollzy = function () {
  ...
  _createClass(Scrollzy, [{
    ...
    value: function init() {
      ...
      this.setEventListener(this.opts.trigger, this.opts.scrollTo, this.opts.speed, this.opts.eventType, this.opts.easing);
    }
  }, {
    key: 'setEventListener',
    value: function setEventListener(trigger, scrollToElement, speed, eventType, easing) {
      var _this = this;
      ...
      this.checkTrigger(trigger).on(this.checkEventType(eventType), function () {
        ...
        }, parseInt(_this.checkSpeed(speed), _this.checkEasing(easing)));
      });
    }
  }, {
    key: 'checkTrigger',
    ...
    key: 'checkEasing',
    value: function checkEasing(easing) {
      if (!easing) {
        this.opts.easing = 'linear';
      } else if (typeof easing !== 'string') {
        throw new Error('Easing should be a string, not a ' + (typeof easing === 'undefined' ? 'undefined' : _typeof(easing)) + '.');
      }
      return easing;
    }
  }]);
